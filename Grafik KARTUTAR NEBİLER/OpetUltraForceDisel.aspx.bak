<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OpetUltraForceDisel.aspx.cs" Inherits="Grafik_KARTUTAR_NEBİLER_OpetUltraForceDisel" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="669px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1264px">
                <diagramserializable>
...
<cc1:PointOptions></cc1:PointOptions>
                ...
                <titles>
                    <cc1:ChartTitle Text="OPET ULTRAFORCE DİZEL [KAR TUTAR]" />
                </titles>
