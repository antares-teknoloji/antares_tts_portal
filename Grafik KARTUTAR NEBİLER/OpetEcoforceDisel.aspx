<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OpetEcoforceDisel.aspx.cs" Inherits="Grafik_KARTUTAR_NEBİLER_OpetEcoforceDisel" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="685px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1360px">
                <diagramserializable>
...
<cc1:PointOptions></cc1:PointOptions>
                ...
                <titles>
                    <cc1:ChartTitle Text="OPET ECOFORCE DİZEL [KAR TUTAR]" />
                </titles>
