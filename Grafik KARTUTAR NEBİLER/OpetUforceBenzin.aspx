<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OpetUforceBenzin.aspx.cs" Inherits="Grafik_KARTUTAR_NEBİLER_OpetUforceBenzin" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="678px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1382px">
                <diagramserializable>
...
<cc1:PointOptions></cc1:PointOptions>
                ...
                <titles>
                    <cc1:ChartTitle Text="OPET 95 OKTAN ULTRA FORCE BENZİN [KAR TUTAR]" />
                </titles>
