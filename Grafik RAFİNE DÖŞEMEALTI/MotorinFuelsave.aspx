<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MotorinFuelsave.aspx.cs" Inherits="Grafik_RAFİNE_DÖŞEMEALTI_MotorinFuelsave" %>
...
<body>
    ...
    <div>
        ...
        <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="692px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1368px">
            <diagramserializable>
