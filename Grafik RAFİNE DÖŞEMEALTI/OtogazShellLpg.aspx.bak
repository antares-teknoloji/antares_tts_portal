<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OtogazShellLpg.aspx.cs" Inherits="Grafik_RAFİNE_DÖŞEMEALTI_OtogazShellLpg" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="714px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1316px">
            <diagramserializable>
...
<cc1:ToolTipMousePosition></cc1:ToolTipMousePosition>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:AKTARIMConnectionString %>" SelectCommand="SELECT [TARIH], [RAFINERIFIYAT], [ISYERI] FROM [YAKIT_KARLILIK] WHERE (([ISYERI] = @ISYERI) AND ([URUNCINS] = @URUNCINS) AND ([TARIH] &gt;= @TARIH))">
            <SelectParameters>
