<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KursunsuzVpower.aspx.cs" Inherits="Grafik_RAFİNE_DÖŞEMEALTI_KursunsuzVpower" %>
...
<body>
    ...
    <div>
        <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="711px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1370px">
            <borderoptions color="White" />
            <diagramserializable>
...
<SeriesTemplate argumentdatamember="TARIH" valuedatamembersserializable="RAFINERIFIYAT"><ViewSerializable>
...
<cc1:PointOptions></cc1:PointOptions>
            ...
            <titles>
                <cc1:ChartTitle Text="KURŞUNSUZ BENZİN 95 OKTAN  V POWER [RAFİNERİ FİYAT]" />
