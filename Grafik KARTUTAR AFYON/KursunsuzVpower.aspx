<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KursunsuzVpower.aspx.cs" Inherits="Grafik_KARTUTAR_AFYON_KursunsuzVpower" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="668px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1365px">
                <diagramserializable>
...
<cc1:PointOptions></cc1:PointOptions>
                ...
                <titles>
                    <cc1:ChartTitle Text="KURŞUNSUZ BENZİN 95 OKTAN  V POWER [KARTUTAR ]" />
                </titles>
