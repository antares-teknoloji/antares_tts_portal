<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OpetUforceBenzin.aspx.cs" Inherits="Grafik_RAFİNE_NEBİLER_OpetUforceBenzin" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="694px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1281px">
                <diagramserializable>
...
<cc1:PointOptions></cc1:PointOptions>
                ...
                <titles>
                    <cc1:ChartTitle Text="OPET 95 OKTAN ULTRA FORCE BENZİN [RAFİNERİ FİYAT]" />
                </titles>
...
<cc1:ToolTipMousePosition></cc1:ToolTipMousePosition>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:AKTARIMConnectionString %>" SelectCommand="SELECT [ISYERI], [RAFINERIFIYAT], [TARIH] FROM [YAKIT_KARLILIK] WHERE (([ISYERI] = @ISYERI) AND ([URUNCINS] = @URUNCINS))">
                <SelectParameters>
                    ...
                    <asp:Parameter DefaultValue="OPET 95 OKTAN ULTRA FORCE BENZİN" Name="URUNCINS" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
        </div>
    </form>
