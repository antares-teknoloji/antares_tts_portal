<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MotorinEuro.aspx.cs" Inherits="Grafik_RAFİNE_KEMER_MotorinEuro" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="661px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1286px">
                <diagramserializable>
