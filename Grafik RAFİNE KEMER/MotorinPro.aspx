<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MotorinPro.aspx.cs" Inherits="Grafik_RAFİNE_KEMER_MotorinPro" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="626px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1328px">
                <diagramserializable>
