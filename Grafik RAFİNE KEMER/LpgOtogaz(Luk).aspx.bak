<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LpgOtogaz(Luk).aspx.cs" Inherits="Grafik_RAFİNE_KEMER_LpgOtogaz_Luk_" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="730px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1367px">
                <diagramserializable>
...
<cc1:PointOptions></cc1:PointOptions>
                ...
                <titles>
                    <cc1:ChartTitle Text="LPG OTOGAZ - LUKOİL [RAFİNERİ FİYAT]" />
                </titles>
