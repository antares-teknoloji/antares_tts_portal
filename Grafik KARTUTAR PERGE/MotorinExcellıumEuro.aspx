<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MotorinExcellıumEuro.aspx.cs" Inherits="Grafik_KARTUTAR_PERGE_MotorinExcellıumEuro" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="695px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1299px">
                <diagramserializable>
...
<cc1:SolidFillOptions></cc1:SolidFillOptions>
                ...
                <titles>
                    <cc1:ChartTitle Text="MOTORİN  EXCELLIUM EURO DIESEL (TOTAL) [KAR TUTAR]" />
                </titles>
...
<cc1:ToolTipMousePosition></cc1:ToolTipMousePosition>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:AKTARIMConnectionString %>" SelectCommand="SELECT [TARIH], [KARTUTAR], [ISYERI] FROM [YAKIT_KARLILIK] WHERE (([ISYERI] = @ISYERI) AND ([URUNCINS] = @URUNCINS))">
                <SelectParameters>
                    ...
                    <asp:Parameter DefaultValue="MOTORİN  EXCELLIUM EURO DIESEL (TOTAL)" Name="URUNCINS" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
        </div>
    </form>
