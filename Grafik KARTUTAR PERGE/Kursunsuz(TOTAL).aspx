<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Kursunsuz(TOTAL).aspx.cs" Inherits="Grafik_KARTUTAR_PERGE_Kursunsuz_TOTAL_" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="685px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1367px">
                <diagramserializable>
...
<cc1:PointOptions></cc1:PointOptions>
                ...
                <titles>
                    <cc1:ChartTitle Text="KURŞUNSUZ BENZİN 95 OKTAN  EXCELLIUM (TOTAL) [KAR TUTAR]" />
                </titles>
