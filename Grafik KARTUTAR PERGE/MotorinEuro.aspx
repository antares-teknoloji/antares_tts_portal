<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MotorinEuro.aspx.cs" Inherits="Grafik_KARTUTAR_PERGE_MotorinEuro" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="672px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1345px">
                <diagramserializable>
...
<cc1:SolidFillOptions></cc1:SolidFillOptions>
                ...
                <titles>
                    <cc1:ChartTitle Text="MOTORİN EURO DIESEL (TOTAL) [KAR TUTAR]" />
                </titles>
