<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OtogazLpg.aspx.cs" Inherits="Grafik_KARTUTAR_PERGE_OtogazLpg" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="700px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1391px">
                <diagramserializable>
...
<cc1:PointOptions></cc1:PointOptions>
                ...
                <titles>
                    <cc1:ChartTitle Text="OTOGAZ - LPG (TOTAL) [KAR TUTAR]" />
                </titles>
