<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KursunsuzFuelsave.aspx.cs" Inherits="Grafik_RAFİNE_AFYON_KursunsuzFuelsave" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="712px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1380px">
                <diagramserializable>
