<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KursunuzVpower.aspx.cs" Inherits="Grafik_RAFİNE_AFYON_KursunuzVpower" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="671px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1254px">
                <diagramserializable>
