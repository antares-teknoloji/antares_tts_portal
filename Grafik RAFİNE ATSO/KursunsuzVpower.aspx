<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KursunsuzVpower.aspx.cs" Inherits="Grafik_RAFİNE_ATSO_KursunsuzVpower" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="682px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1317px">
                <diagramserializable>
