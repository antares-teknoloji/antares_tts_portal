<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MotorinFuelsave.aspx.cs" Inherits="Grafik_RAFİNE_ATSO_MotorinFuelsave" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="690px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1415px">
                <diagramserializable>
