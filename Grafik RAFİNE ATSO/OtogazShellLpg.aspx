<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OtogazShellLpg.aspx.cs" Inherits="Grafik_RAFİNE_ATSO_OtogazShellLpg" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="703px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1238px">
                <diagramserializable>
