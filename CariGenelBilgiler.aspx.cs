...
public partial class CariGenelBilgiler : System.Web.UI.Page
{
    ...
    protected void btnGuncelle_Click(object sender, EventArgs e)
    {
        ...
        {
            SqlCommand cmdKaydet = new SqlCommand("INSERT INTO TTSPORTAL_CARIBILGI (CARIKOD,CARIAD,OTOMATIKLISTE,BAKIYELISTE,TAAHHUTLITRE,TEMINATTUR,TEMINATTUTAR,TEMINATTUR2,TEMINATTUTAR2,ANABAYIKOD,OFFLINELIMIT,MUSTERIISTASYON,ODEMETUR,BANKADBSKOD,BANKADBSKOD2,SHELLVADE1,SHELLVADE2,LUKOILBIZIMMOTORIN,LUKOILBIZIMBENZIN,LUKOILDIGERMOTORIN,LUKOILDIGERBENZIN,TOTALBIZIMMOTORIN,TOTALBIZIMBENZIN,TOTALDIGERMOTORIN,TOTALDIGERBENZIN,SOZLESMEBASLANGIC,SOZLESMEBITIS,SATISPERSONEL,SHELLMUSTERIKOD,ACIKLAMA,BANKAAD,BANKAAD2,ONLINELIMIT,GENELRAPOR,SHELLBIZIMMOTORINTL,SHELLBIZIMBENZINTL,SHELLDIGERMOTORINTL,SHELLDIGERBENZINTL,TOLERANSSURE,ONLINELIMIT2,LUKOILANABAYIKOD,LUKOILODEMEVADE1,LUKOILODEMEVADE2,TOTALANABAYIKOD,TOTALODEMEVADE1,TOTALODEMEVADE2,TOTALODEMEVADE3,ANABAYI,SEKTOR,CIKIS,PRATIKKARTNO) VALUES (@CARIKOD,@CARIAD,@OTOMATIKLISTE,@BAKIYELISTE,@TAAHHUTLITRE,@TEMINATTUR,@TEMINATTUTAR,@TEMINATTUR2,@TEMINATTUTAR2,@ANABAYIKOD,@OFFLINELIMIT,@MUSTERIISTASYON,@ODEMETUR,@BANKADBSKOD,@BANKADBSKOD2,@SHELLVADE1,@SHELLVADE2,@LUKOILBIZIMMOTORIN,@LUKOILBIZIMBENZIN,@LUKOILDIGERMOTORIN,@LUKOILDIGERBENZIN,@TOTALBIZIMMOTORIN,@TOTALBIZIMBENZIN,@TOTALDIGERMOTORIN,@TOTALDIGERBENZIN,@SOZLESMEBASLANGIC,@SOZLESMEBITIS,@SATISPERSONEL,@SHELLMUSTERIKOD,@ACIKLAMA,@BANKAAD,@BANKAAD2,@ONLINELIMIT,@GENELRAPOR,@SHELLBIZIMMOTORINTL,@SHELLBIZIMBENZINTL,@SHELLDIGERMOTORINTL,@SHELLDIGERBENZINTL,@TOLERANSSURE,@ONLINELIMIT2,@LUKOILANABAYIKOD,@LUKOILODEMEVADE1,@LUKOILODEMEVADE2,@TOTALANABAYIKOD,@TOTALODEMEVADE1,@TOTALODEMEVADE2,@TOTALODEMEVADE3,@ANABAYI,@SEKTOR,@CIKIS,@PRATIKKARTNO)", connBizim);
