<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MotorinPro.aspx.cs" Inherits="Grafik_RAFİNE_LUKOIL_MotorinPro" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="686px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1366px">
                <diagramserializable>
...
<cc1:PointOptions></cc1:PointOptions>
                ...
                <titles>
                    <cc1:ChartTitle Text="MOTORİN (ECTO PRODIESEL) [RAFİNERİ FİYAT]" />
                </titles>
