<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MotorinEuro.aspx.cs" Inherits="Grafik_KARTUTAR_KEMER_MotorinEuro" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="652px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1326px">
                <diagramserializable>
