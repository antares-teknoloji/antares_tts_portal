<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Kursunsuz(Luk).aspx.cs" Inherits="Grafik_KARTUTAR_KEMER_Kursunsuz_Luk_" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="686px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1346px">
                <diagramserializable>
