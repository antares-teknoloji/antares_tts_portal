<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MotorinVpower.aspx.cs" Inherits="Grafik_KARTUTAR_DÖŞEMEALTI_MotorinVpower" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="717px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1394px">
                <diagramserializable>
...
<cc1:SolidFillOptions></cc1:SolidFillOptions>
                ...
                <titles>
                    <cc1:ChartTitle Text="MOTORİN-SHELL V-POWER  NITRO+ DIESEL [KAR TUTAR]" />
                </titles>
...
<cc1:ToolTipMousePosition></cc1:ToolTipMousePosition>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:AKTARIMConnectionString %>" SelectCommand="SELECT [ISYERI], [KARTUTAR], [TARIH] FROM [YAKIT_KARLILIK] WHERE (([URUNCINS] = @URUNCINS) AND ([ISYERI] = @ISYERI))">
                <SelectParameters>
