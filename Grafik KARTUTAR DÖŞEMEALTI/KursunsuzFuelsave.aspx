<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KursunsuzFuelsave.aspx.cs" Inherits="Grafik_KARTUTAR_DÖŞEMEALTI_KursunsuzFuelsave" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="619px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1404px">
                <diagramserializable>
