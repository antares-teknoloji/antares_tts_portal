<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KursunsuzVpower.aspx.cs" Inherits="Grafik_KARTUTAR_DÖŞEMEALTI_KursunsuzVpower" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="667px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1388px">
                <diagramserializable>
