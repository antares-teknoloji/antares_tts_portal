<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OtogazShellLpg.aspx.cs" Inherits="Grafik_KARTUTAR_KORKUTELİ_OtogazShellLpg" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="671px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1345px">
                <diagramserializable>
...
<cc1:SolidFillOptions></cc1:SolidFillOptions>
                ...
                <titles>
                    <cc1:ChartTitle Text="OTOGAZ-SHELL AUTOGAZ LPG [KAR TUTAR]" />
                </titles>
