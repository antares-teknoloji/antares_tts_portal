<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KursunsuzFuealsave.aspx.cs" Inherits="Grafik_KARTUTAR_KORKUTELİ_KursunsuzFuealsave" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="611px" SideBySideEqualBarWidth="True" Width="1303px" SeriesDataMember="ISYERI">
                <diagramserializable>
...
<cc1:SolidFillOptions></cc1:SolidFillOptions>
                ...
                <titles>
                    <cc1:ChartTitle Text="KURŞUNSUZ BENZİN 95 OKTAN-SHELL FUELSAVE [KARTUTAR]" />
                </titles>
