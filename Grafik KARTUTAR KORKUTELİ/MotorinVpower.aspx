<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MotorinVpower.aspx.cs" Inherits="Grafik_KARTUTAR_KORKUTELİ_MotorinVpower" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="640px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1269px">
                <diagramserializable>
