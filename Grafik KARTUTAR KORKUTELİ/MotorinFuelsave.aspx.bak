<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MotorinFuelsave.aspx.cs" Inherits="Grafik_KARTUTAR_KORKUTELİ_MotorinFuelsave" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="671px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1263px">
                <diagramserializable>
