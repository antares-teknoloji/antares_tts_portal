<%@ Page Title="" Language="C#" MasterPageFile="~/Genel.master" AutoEventWireup="true" CodeFile="AlimKapatmaRapor.aspx.cs" Inherits="AlimKapatmaRapor"  EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <br />
    <div>
        <asp:Button ID="btnKapat" runat="server" Text="Kapat" OnClientClick="return confirm('Seçili Carilerin Yakıt Alımını Kapatmak İstediğinize Emin Misiniz?');" BackColor="#999999" Font-Bold="True" Font-Overline="False" Font-Strikeout="False" Height="45px" OnClick="btnKapat_Click" Width="136px"/>
    </div>
    <br />
    <div>
