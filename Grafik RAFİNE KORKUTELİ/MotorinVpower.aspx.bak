<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MotorinVpower.aspx.cs" Inherits="Grafik_RAFİNE_KORKUTELİ_MotorinVpower" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="600px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1153px">
                <diagramserializable>
