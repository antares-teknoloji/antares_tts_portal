<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KursunsuzVpower.aspx.cs" Inherits="Grafik_RAFİNE_KORKUTELİ_KursunsuzVpower" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="651px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1235px">
                <diagramserializable>
