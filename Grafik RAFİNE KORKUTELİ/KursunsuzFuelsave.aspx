<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KursunsuzFuelsave.aspx.cs" Inherits="Grafik_RAFİNE_KORKUTELİ_KursunsuzFuelsave" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="666px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1253px">
                <diagramserializable>
...
<cc1:SolidFillOptions></cc1:SolidFillOptions>
                ...
                <titles>
                    <cc1:ChartTitle Text="KURŞUNSUZ BENZİN 95 OKTAN-SHELL FUELSAVE [RAFİNERİ FİYAT]" />
                </titles>
...
<cc1:ToolTipMousePosition></cc1:ToolTipMousePosition>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:AKTARIMConnectionString %>" SelectCommand="SELECT [ISYERI], [TARIH], [RAFINERIFIYAT] FROM [YAKIT_KARLILIK] WHERE (([ISYERI] = @ISYERI) AND ([URUNCINS] = @URUNCINS))">
                <SelectParameters>
