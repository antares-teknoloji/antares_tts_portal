<%@ Page Title="" Language="C#" MasterPageFile="~/Genel.master" AutoEventWireup="true" CodeFile="RiskliCariRapor.aspx.cs" Inherits="RiskliCariRapor" EnableEventValidation="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
    <div>
        <asp:GridView ID="grdRiskliCari" runat="server" CellPadding="3" ShowFooter="True" Style="text-align: left" Width="100%" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CaptionAlign="Right" CellSpacing="1" Font-Size="Small" GridLines="None" OnRowCreated="grdRiskliCari_RowCreated">
