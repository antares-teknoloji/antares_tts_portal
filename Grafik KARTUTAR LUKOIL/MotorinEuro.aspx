<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MotorinEuro.aspx.cs" Inherits="Grafik_KARTUTAR_LUKOIL_MotorinEuro" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="712px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1360px">
                <diagramserializable>
...
<cc1:PointOptions></cc1:PointOptions>
                ...
                <titles>
                    <cc1:ChartTitle Text="MOTORİN (+) (ECTO eurodiesel) [KAR TUTAR]" />
                </titles>
