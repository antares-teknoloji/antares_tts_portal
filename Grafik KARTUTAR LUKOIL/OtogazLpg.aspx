<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OtogazLpg.aspx.cs" Inherits="Grafik_KARTUTAR_LUKOIL_OtogazLpg" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="672px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1304px">
                <diagramserializable>
