<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MotorinPro.aspx.cs" Inherits="Grafik_KARTUTAR_LUKOIL_MotorinPro" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" DataSourceID="SqlDataSource1" Height="703px" SeriesDataMember="ISYERI" SideBySideEqualBarWidth="True" Width="1395px">
                <diagramserializable>
